...
"""
class Settings:
    def __init__(self, window_size, stride, n_nodes, alpha, decay, n_epochs, data_split, dropout_ratio, train_location, ac_fun):
        # Window size
...
class Data:
    ...
    def __init__(self, settings, location):
        ...
        # load data
        d_1, l_1, d_2, l_2, d_3, l_3, = self.__load_data(location, settings.data_split)
