...
print(labels.shape)
number_of_sensors = labels.shape[0]
...
window_size = 32
# win_x, win_y = turn_into_windows(x_data, y_labels, window_size=window_size)
# # # flatten arrays
...
# model.add(layers.Embedding(input_dim=1024, output_dim=64))

# Add a LSTM layer with 128 internal units.
model.add(layers.LSTM(256, input_shape=(window_size, number_of_sensors * 2)))
