...
def load_data_csv(file_location, train_test_ratio):
    ...
    WIDTH = 20
    # TODO: Combine vx_data and vy_data into one data struct to eventually split into train and test
    # TODO: Calculate labels (i.e. positions) per sensor input
    ...
    all_data = []
    all_labels = []
    # TODO: Remove the //8192
    for v_idx in range(len(vx_data) // 8192):
        all_data.append(
            list(
                islice(
                    chain.from_iterable(
    ...
    # TODO: Randomly select data in an 80/20 split

    # TODO: write proper test to check if all_data and all_labels are equal length
...
def main(n_nodes, window_size, stride, model_type="ELM"):
    ...
    # load dataset
    # dataset = 'clearsignal_close.mat'
    # dataset = 'all_spheres.mat'
    # filename = '../../data/deflection-reconstructed_data/Experiment_I/' + dataset

    # TODO: Split up loading and splitting 80/20
    x_train, y_train, x_test, y_test = load_data_csv("", 0.8)
