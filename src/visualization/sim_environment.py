...
def main():
    ...
    # Sensors
    num_sensors = 8
    sensors_x = list(np.linspace(int(512 - (200/500 * 512)), int(512 + (200/500 * 512)), num=num_sensors))
    sensors_y = [190] * num_sensors
    ax[0].scatter(sensors_x, sensors_y, s=60, label="Sphere", color="#265650CA", zorder=1)
