...
class ELM(BaseEstimator, ClassifierMixin):
    ...
    def __init__(self, hid_num: int, sigmoidConstant: int = 1):
        ...
        sigmoidConstant: const value of sigmoid funcion
        """
    ...
    def add_bias(self, X):
        ...
        Examples:
        >>> e = ELM(10, 3)
        >>> e.add_bias(np.array([[1,2,3], [1,2,3]]))
        array([[1., 2., 3., 1.],
               [1., 2., 3., 1.]])
        """
    ...
    def save(self, name="trainedModel"):
        # TODO: Add checks that the model has already been trained
        import pickle
        with (open(name + ".pkl", "w")) as f:
            pickle.dump(self.X, f)

    def load(self, name="trainedModel"):
        # TODO: Add checks that the model has already been trained
        import pickle
